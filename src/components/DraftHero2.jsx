...
const DraftHero2 = () => {
  ...
  return (
    <div
      className="flex w-full h-screen justify-center items-center bg-black overflow-hidden relative"
      ref={scope}
    >
      <motion.div
      ...
      >
        ...
        <div className="flex items-center justify-center gap-2 text-xs z-50 hover:scale-110 transition-transform bg-white text-black rounded-full py-2 px-4 cursor-pointer">
          <Download size={16} />
          <span>Download</span>
        </div>
      </motion.div>
