  ...
  const EducationAndWork = () => {
      ...
      return (
        <div className='flex items-center md:gap-7 gap-5'>
          ...
          <div className='md:pace-y-2 space-y-3'>
            <h5 id='text-animation' className='leading-tight'>{title}</h5>
            <span id='text-animation' className='block md:text-sm text-xs text-indigo-100/90'>{name} <span className='ms-1 text-xs text-indigo-200/90 px-[5px] py-[1px] border border-indigo-300/5 bg-indigo-400/5 rounded-lg'>{setup}</span></span>
            <span id='text-animation' className='block md:text-sm text-xs text-indigo-100/90'>{date}  <span className='ms-1 text-xs text-indigo-200/90 px-[5px] py-[1px] border border-indigo-300/5 bg-indigo-400/5 rounded-lg'>{duration}</span></span>
          </div>
        </div>
      )
    }
    ...
    return (
      <div className='lg:px-36 md:px-28 px-4 md:pt-24 pt-4 py-4'>
        <div id='exp-contents' className='grid lg:grid-cols-2 grid-cols-1 md:gap-8 gap-12'>
          {/* Education */}
          <div className='space-y-10'>
            <h2 id='text-animation'>education.</h2>
          ...
          {/* Work Experience */}
          <div className='space-y-10'>
            <h2 id='text-animation'>work experience.</h2>
            <div className='space-y-8'>
              {/* Tech-Commr */}
              <Container
                logo={TechCommrLogo}
          ...
          <div className='md:p-[1.5px] p-[1px] h-full certis-container-glow rounded-4xl'>
            <div className='relative bg-[#15131C] w-full h-full rounded-[31px] grid md:grid-cols-2 grid-cols-1 overflow-hidden'>
              ...
              <div className='z-30 lg:p-30 md:p-22 p-6 space-y-4'>
                <span id='text-animation' className='block md:text-4xl text-3xl text-[#15131C] font-bold'>certifications.</span>
                <span id='text-animation' className='block text-sm text-[#15131C] font-bold w-full max-w-xs'>Lorem, ipsum dolor sit amet consecur adipicing elit. Nisi beatae nobis nihil minima.</span>
              ...
              <div className='grid grid-cols-3 gap-7 lg:pr-36 md:pr-0'>
                ...
                <div className='flex flex-col justify-start items-start gap-2 -skew-x-36 -mt-20'>
                  <div id='exp-bottom' className='h-auto' />
                ...
                <div className='flex flex-col gap-2 -skew-x-36 -mt-32'>
                  <div id="exp-top" className="h-auto" />
